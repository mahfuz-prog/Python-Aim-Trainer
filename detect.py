...
# used to stack multiple images. code from Murtaza's Workshop
...
while True:
    '''
    take an image where we want to detect color.
    after tuning Hue, Saturation, Value the target color
    should be white in the final image output and everything else
    dark.
    '''
